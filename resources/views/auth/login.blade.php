...
<body>
    <div class="container-fluid  d-flex  justify-content-center align-items-center">
        <div class="row h-75 w-75 postal  top-50 start-50 translate-middle shadow p-4">
...
>>>>>>> cab02af6e1eb5ac9144a579df1f20623500bf9ce
            </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <!-- <div class="mb-5 d-flex justify-content-between align-items-center">
                            <div class="form-check">
                                ...
                                <label class="remeberPassword" for="recordarContrasena">Recordar contraseña</label>
                            </div>
